...
public class GeneratorDemo {
	...
	public static void main(String[] args) {
		...
		// 添加不需要生成的表名
		gernerator.addExcludedTable("console_orgnization","console_orgnization_websys","console_dictionary",
				"console_resource","console_role","console_role_resource","console_role_station","console_station","console_user","console_user_station","console_websys");
